...
if !exists('g:obviousModeInsertHi')
    let g:obviousModeInsertHi = 'guibg=ForestGreen'
endif

if !exists('g:obviousModeCmdwinHi')
    let g:obviousModeCmdwinHi = 'guibg=DarkSlateGray'
endif

if !exists('g:obviousModeModifiedCurrentHi')
    let g:obviousModeModifiedCurrentHi = 'guibg=DarkSlateGray'
endif

if !exists('g:obviousModeModifiedNonCurrentHi')
    let g:obviousModeModifiedNonCurrentHi = 'guibg=DarkSlateGray'
endif

if !exists('g:obviousModeModifiedVertSplitHi')
    let g:obviousModeModifiedVertSplitHi = 'guibg=DarkSlateGray'
endif
